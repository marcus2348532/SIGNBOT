...
import warnings
from google.protobuf.message import DecodeError  # Import a protobuf-related class

warnings.filterwarnings("ignore", category=UserWarning, module='google.protobuf')

# Configure the Google Generative AI API
genai.configure(api_key=os.getenv("API_KEY"))  # Use environment variable for security
    ...
    if not result_queue.empty():
        ...
        if time.time() - last_sign_time > chatbot_response_threshold and sign_string.strip():
            try:
                ...
                response = model.generate_content(sign_string.strip())
